...
document.addEventListener('DOMContentLoaded', () => {
  ...
  safeInit('BackgroundShader', initBackgroundShader);
...
/* ==========================================================================
   0.1 FULL-WEBSITE WEBGL SHADER BACKGROUND TEXTURE
   ========================================================================== */
...
void main() {
    ...
    // Deep technical colors (from portfolio references)
    vec3 color1 = vec3(0.02, 0.02, 0.05); // Deep space blue/black
    vec3 color2 = vec3(0.05, 0.05, 0.15); // Subtle navy glow
    vec3 accent = vec3(0.2, 0.3, 0.8);    // Electric blue highlight
    
    float mask = smoothstep(-0.2, 0.8, n1 * 0.5 + n2 * 0.5);
    ...
    // Add fine mesh texture for "Technical" look
    float grid = sin(uv.x * u_resolution.x * 0.1) * sin(uv.y * u_resolution.y * 0.1);
    finalColor += grid * 0.005;
